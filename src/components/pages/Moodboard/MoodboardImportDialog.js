      ...
      <DialogTitle sx={{ pb: 1 }}>
        <Stack spacing={0.5}>
          ...
          <Typography color="#8a6a5c" fontSize={14}>
            Paste the exported moodboard JSON here to replace the current board.
          </Typography>
        </Stack>
      </DialogTitle>
...
export default MoodboardImportDialog;
